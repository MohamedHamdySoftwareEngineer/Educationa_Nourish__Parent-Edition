...
import 'package:educational_nourish/Parent/features/Exam/bloc/exam_bloc.dart';
import 'package:educational_nourish/Parent/features/Exam/presentation/views/widgets/exam_screen_body.dart';
...
class ExamScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ExamBloc(apiService: ApiService())..add(const FetchExam('21101')),
      child:  Scaffold(
