      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              top:
                  40, // Adjust this to match the red circle's vertical position
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: ListView(
                      children: const [
                        ProfileDetail(label: "YourName", value: "Mohamed Hamdy"),
                        ProfileDetail(label: "Email", value: "mohamedhamdy@376.com"),
